...
import { targetSize, PlantingTarget } from './PlantingTarget';
...
export function PlantingMarker({ map, onPlantClick }) {
  ...
  return (
    ...
    >
      <Container>
        ...
        <Toolbar>
          <TooltipBottom title="Enter the details for the new tree">
            <AddButton
