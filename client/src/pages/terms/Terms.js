...
function Terms(props) {
  ...
  return (
    <div className="terms">
      ...
      <p>Welcome to Water the Trees!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of
        Water the Trees&apos;s Website, located at https://waterthetrees.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions.
        Do not continue to use Water the Trees if you do not agree to take all of
      ...
      <p>
        ...
        website and compliant to the Water the Tree’s terms and conditions. &quot;The
        Water the Tree&quot;, &quot;Ourselves&quot;, &quot;We&quot;, &quot;Our&quot; and
        &quot;Us&quot;, refers to our Water the Tree. &quot;Party&quot;,
        ...
        Client’s needs in respect of provision of the Water the Tree’s stated services, in
        accordance with and subject to, prevailing law of Netherlands. Any use of
        the above terminology or other words in the singular, plural, capitalization
      ...
      <p>
        We employ the use of cookies. By accessing Water the Trees, you agreed to
        use cookies in agreement with the Water the Trees&apos;s Privacy Policy.
        {' '}
      </p>
      ...
      <p>
        Unless otherwise stated, Water the Trees and/or its licensors own the
        intellectual property rights for all material on Water the Trees. All
        intellectual property rights are reserved. You may access this from Water
        the Trees for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Water the Trees</li>
        <li>Sell, rent or sub-license material from Water the Trees</li>
        <li>Reproduce, duplicate or copy material from Water the Trees</li>
        <li>Redistribute content from Water the Trees</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and exchange
        opinions and information in certain areas of the website. Water the Trees
        does not filter, edit, publish or review Comments prior to their presence on
        the website. Comments do not reflect the views and opinions of Water the
        Trees,its agents and/or affiliates. Comments reflect the views and opinions
        of the person who post their views and opinions. To the extent permitted by
        applicable laws, Water the Trees shall not be liable for the Comments or for
        any liability, damages or expenses caused and/or suffered as a result of any
        use of and/or posting of and/or appearance of the Comments on this website.
      </p>

      <p>
        Water the Trees reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Water the Trees a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your Comments in
      ...
      <ul>
        ...
        <li>Hamster phone organizations;</li>
        <li>
      ...
      <ul>
        ...
        <li>diamond planets</li>
        <li>spaceships with greenery</li>
      </ul>
      ...
      <p>
        ...
        compensates the absence of Water the Trees; and (d) the link is in the
      ...
      <p>
        ...
        e-mail to Water the Trees. Please include your name, your organization name,
        contact information as well as the URL of your site, a list of any URLs from
        which you intend to link to our Website, and a list of the URLs on our site
      ...
      <ul>
        <li>By use of our Watering Can name; or</li>
      ...
      <p>
        You can ONLY use Water the Trees&apos;s to plant trees and potatos.
        If you plant no potatos, that is sad.
      </p>
