  ...
  return (
    <Page title={component_name}  className={component_name}  >
      <Row className="d-flex justify-content-sm-center">
        ...
        <p>
          100K Trees is working to plant urban trees and forests, restore 
          our natural habitat for birds, insects and fauna, 
          and assure the increase of carbon sequestration 
          capacity.
          </p>
        </Col>
        <Col sm='12'>
        <div className="gfm-embed" data-url="https://www.gofundme.com/f/100k-trees-for-humanity/widget/large"></div>
        </Col>
        <Col sm='12'>
