...
// function TreeInput({control, setTreeInfo}) {

//   const handleChange = (event, newValue) => {
//     // console.log(componentName, '\n\n\n\n', 'handleChange keyName', keyName);
//     // console.log(componentName, 'newValue', newValue, event.target.value);
//     const value = getValues(keyName);
//     // console.log(componentName, 'getValues', getValues());
//     if (value) {
//       setTreeInfo({ ...treeInfo, [keyName]: value });
//     } else if (event.target.value) {
//       setTreeInfo({ ...treeInfo, [keyName]: event.target.value });
//     } else if (newValue) {
//       setTreeInfo({ ...treeInfo, [keyName]: newValue });
//     }
//   };
