...
function Mapper() {
  ...
  useEffect(() => {
    if (!treeListMap) {
      const request = {
        ...
        sLat: center.lat - 0.01,
        wLng: center.lng - 0.001,
        nLat: center.lat + 0.01,
        eLng: center.lng + 0.001,
      };
  ...
  return (
    ...
    >
      ...
      >
        {treeListMap &&
          treeListMap.length > 0 &&
          treeListMap.map((tree) => {
            ...
            return (
              <Feature
                ...
                onClick={() => {
                  handleClickedTree(tree.inventoryid, tree);
                }}
                onHover={() => {
                  setShowTreePopper(tree);
                }}
