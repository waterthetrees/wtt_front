      ...
      <div className="scrollable">
        ...
        <div>
          ...
          <div className="privacy-p">
            ...
            but not limited to your name, email, and location. The information
          ...
          <div className="privacy-p">
            ...
            following reasons: To facilitate our Tree Planting; To provide Tree
            Planting on our behalf; To performTree Planting-related services; or
            To assist us in analyzing how Water the Trees is used.
          </div>

          <div className="privacy-p">
            We want to inform Water the Trees users that these third parties have
