...
async function loadURL(page, url) {
  ...
  logger.log('debug', `${functionName} ${page} ${util.inspect(url, false, 10, true)} ----==\n\n\n`);
  try {
...
module.exports = {shouldNotExist, shouldExist, pressKey, getCount, getText, loadURL, waitForFrame, click, typeText, waitForText};